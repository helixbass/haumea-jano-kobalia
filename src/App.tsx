...
import {MorphSVGPlugin} from 'utils/gsap/MorphSVGPlugin'
...
const Eyebrow: FC = flowMax(
  addDisplayName('Eyebrow'),
  addRefsContext,
  ({setRef}) => (
    <path
      ref={setRef('eyebrow')}
...
const CheekDot: FC = flowMax(
  addDisplayName('CheekDot'),
  addRefsContext,
  ({setRef}) => (
    <path
      ref={setRef('cheekDot')}
...
const Flower: FC = flowMax(
  addDisplayName('Flower'),
  addRefsContext,
  ({setRef}) => (
...
const App: FC = flowMax(
  ...
  addLayoutEffectOnMount(({refs}) => () => {
    ...
    gsap
      ...
      .set(hair, {
        morphSVG:
          'M 0 300 h 600 c 40 0, 100 60, 100 100 v 300 h -800 v -300 c 0 -40, 60 -100, 100 -100 z',
        opacity: 1,
        y: 400,
      })
      .to(hair, {
